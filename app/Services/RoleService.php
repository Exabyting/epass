...
class RoleService
{
    ...
    public function getSystemAnalystUser()
    {
        $systemAnalystRole = $this->findBy(['name' => 'ROLE_SYSTEM_ANALYST'])->first();
        return $systemAnalystRole->users()->first();
    }

    public function getSystemAdminUser()
    {
        $systemAnalystRole = $this->findBy(['name' => 'ROLE_SUPER_ADMIN'])->first();
        return $systemAnalystRole->users()->first();
    }
