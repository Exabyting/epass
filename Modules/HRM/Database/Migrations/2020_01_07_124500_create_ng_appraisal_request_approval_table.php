...
class CreateNgAppraisalRequestApprovalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ng_appraisal_request_approvals', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ng_appraisal_request_approvals');
    }
}
