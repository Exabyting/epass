...
use Modules\HRM\Entities\NGAppraisalRequestJobHistory;
use Modules\HRM\Repositories\NGAppraisalRequestRepository;
use Modules\HRM\Traits\HistoryTrait;

class NGAppraisalRequestService
{
    ...
    public function __construct(
        NGAppraisalRequestRepository $ngAppraisalRequestRepository,
        AppraisalRequestEvaluationService $ngAppraisalRequestEvaluationService,
        EmployeeServices $employeeServices
    )
    {
        $this->setActionRepository($ngAppraisalRequestRepository);
    ...
    public function requestSubmit(Model $appraisalRequest)
    {
        return DB::transaction(function () use ($appraisalRequest) {
            ...
            // Keep History
            $this->ngInitiateHistory($appraisalRequest, $appraisalRequest->requester_id, $appraisalRequest->receiver_id);
            ...
            $this->sendNotification(
                ...
                route('ng-appraisal-request.first-evaluation', $appraisalRequest->id)
            );
            ...
            $route = route('ng-appraisal-request.first-evaluation', $appraisalRequest->id);
