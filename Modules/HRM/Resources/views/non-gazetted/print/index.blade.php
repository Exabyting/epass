...
<head>
    ...
    <title>{{ $ngAppraisalRequest->requester->first_name }} {{ $ngAppraisalRequest->requester->last_name }}
        - {{ date('d M, Y', strtotime($ngAppraisalRequest->reporting_date_start)) }}
        - {{ date('d M, Y', strtotime($ngAppraisalRequest->reporting_date_end)) }} - ACR</title>
