                                            ...
                                            <div class="row skin skin-square">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    @foreach(trans('hrm::appraisal.action-rating-options') as $key => $value)
                                                        @if($ngAppraisalRequest->action->rating == $key)
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea readonly name="comment" class="form-control required" rows="5"
                                                      data-msg-required="{{ trans('labels.This field is required')}}">{{$ngAppraisalRequest->action->comment}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{--                                </a>--}}
                                <a class="btn btn-info mr-1" role="button"
                                   href="{{ route('ng-appraisal-request.action', [$ngAppraisalRequest->id]) }}">
                                    <i class="la la-edit white"></i> @lang('labels.edit')
                                </a>
