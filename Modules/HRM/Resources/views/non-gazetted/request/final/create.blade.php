...
@section('content')
    @include('hrm::non-gazetted.request.final.partials.evaluation_completed')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['ng-appraisal-request-approval.store', 'ngAppraisalRequest' => $ngAppraisalRequest->id ],'class' => 'form appraisal-request-form']) !!}
                            @include('hrm::non-gazetted.request.final.partials.form')
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
