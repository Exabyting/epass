<div class="form-body">
    ...
    <div class="row justify-content">
        <div class="col-md-6">
            {{ Form::hidden('appraisal_request_id', $ngAppraisalRequest->id ) }}
            <div class="form-group {{ $errors->has('filled_up_date') ? ' error' : '' }}">
                ...
                {!! Form::text('filled_up_date', date('d-m-Y', time($ngAppraisalRequest->updated_at)),
                    [
                        'class' => "form-control",
                        "readonly",
            ...
            <div class="form-group {{ $errors->has('cause_of_late') ? ' error' : '' }}">
                ...
                {!! Form::text('cause_of_late', optional($ngAppraisalRequest->approval)->cause_of_late,
                    [
                        'class' => "form-control",
            ...
            <div class="form-group {{ $errors->has('work_on_application') ? ' error' : '' }}">
                ...
                {!! Form::text('work_on_application', optional($ngAppraisalRequest->approval)->work_on_application,
                    [
                        'class' => "form-control",
