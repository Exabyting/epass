...
{{--            @cannot('system-analyst')--}}
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        @if(auth()->user()->can('gazetted-officer') || auth()->user()->cannot('non-gazetted-officer')|| auth()->user()->cannot('gazetted-cadre-officer'))
                            <li class="nav-item {{ is_active_route('appraisal-request.index') }}">
                                <a class="nav-link" href="{{ route('appraisal-request.index') }}"><i
                                        class="la la-list"></i>
                        ...
                        @endif
                        @if(auth()->user()->cannot('gazetted-officer')|| auth()->user()->cannot('gazetted-cadre-officer') || auth()->user()->can('non-gazetted-officer'))
                        ...
                        @endif
                            @if(auth()->user()->cannot('gazetted-officer')|| auth()->user()->cannot('non-gazetted-officer')|| auth()->user()->can('gazetted-cadre-officer'))
                                <li class="nav-item {{ is_active_route('gco-appraisal-request.index') }}">
                                    <a class="nav-link" href="{{ route('gco-appraisal-request.index') }}"><i
                                                class="la la-list"></i>
                                        <span class="menu-title"
                                              data-i18n="nav.dash.main">@lang('hrm::appraisal.request') @lang('labels.list') (GCO)</span>
                                    </a>
                                </li>
                            @endif
                        <li class="nav-item {{ is_active_route('appraisal-report.index') }}">
                            <a class="nav-link" href="{{ route('appraisal-report.index') }}"><i
                                    class="la la-list"></i>
                                <span class="menu-title"
...
{{--            @endcannot--}}
            @if(auth()->user()->can('system-analyst') || auth()->user()->can('system-super-admin'))
                <li class="nav-item">
                    <a href="javascript:;"><i class="la la-list"></i>
                        <span class="menu-title"
                              data-i18n="nav.dash.main">@lang('labels.status_approved') @lang('labels.list')</span>
                    </a>
                    <ul class="menu-content">
                        <li class="nav-item {{ is_active_route('appraisal-request.action-list') }}">
                            <a class="nav-link" href="{{ route('appraisal-request.action-list') }}"><i
                                    class="la la-list"></i>
                                <span class="menu-title"
                                      data-i18n="nav.dash.main">@lang('labels.gazetted')  @lang('labels.officer')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ is_active_route('ng-appraisal-request.action-list') }}">
                            <a class="nav-link" href="{{ route('ng-appraisal-request.action-list') }}"><i
                                    class="la la-list"></i>
                                <span class="menu-title"
                                      data-i18n="nav.dash.main">@lang('labels.non-gazetted') @lang('labels.officer')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ is_active_route('gco-appraisal-request.action-list') }}">
                            <a class="nav-link" href="{{ route('gco-appraisal-request.action-list') }}"><i
                                        class="la la-list"></i>
                                <span class="menu-title"
                                      data-i18n="nav.dash.main">@lang('labels.gazetted-cadre-officer')</span>
                            </a>
                        </li>
                    </ul>
                </li>
