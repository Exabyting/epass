                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            @if($gcoAppraisalRequest->requester->user->id == auth()->user()->id && !$gcoAppraisalRequest->is_submitted)
                                <a href="{{ route('gco-appraisal-request.edit', $gcoAppraisalRequest->id) }}"
                                   class="btn btn-primary btn-lg">
                                    <i class="la la-edit white"></i> @lang('hrm::appraisal.report') @lang('labels.edit')
                                </a>
                            @endif
                            @if(!$gcoAppraisalRequest->is_submitted)
                                <a href="{{ route('gco-appraisal-request.submit', $gcoAppraisalRequest->id) }}"
                                   class="btn btn-primary btn-lg">
                                    <i class="ft-mail white"></i> @lang('labels.next_step')
                                </a>
                            @endif
                            @if($gcoAppraisalRequest->is_submitted)
                                <a href="{{ route('gco-appraisal-personal-request.create',$gcoAppraisalRequest->id) }}"
                                   class="btn btn-primary btn-lg">
                                    <i class="ft-mail white"></i> @lang('labels.next_step')
                                </a>
                            @endif
