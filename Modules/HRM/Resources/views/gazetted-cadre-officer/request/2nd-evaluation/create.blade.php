        ...
        <div class="row">
            ...
            <div class="col-md-12">
                {{--<div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['gco-appraisal-request.second-evaluation-store', $gcoAppraisalRequest->id],'class' => 'form appraisal-evaluation-form']) !!}
                            <div class="form-body">
...
{{--                                    <div class="col-md-6">
                            ...
                            <div class="form-actions text-center">
                                @if($gcoAppraisalRequest->receiver->user->id === auth()->user()->id && $gcoAppraisalRequest->is_evaluated)
                                    <a href="{{ route('gco-appraisal-request.first-evaluation-edit', $gcoAppraisalRequest->id) }}"
                                ...
                                @if($gcoAppraisalRequest->receiver->user->id === auth()->user()->id && $gcoAppraisalRequest->is_evaluated)
                                    <a href="{{ route('gco-appraisal-request.third-evaluation', $gcoAppraisalRequest->id) }}"
                                       class="btn btn-primary">
                                        <i class="la la-edit white"></i> @lang('hrm::cadre_officer_info.next_step')
                                    </a>
                                @endif
                               {{-- <button type="submit" class="btn btn-teal">
                                    <i class="la la-check-square-o"></i> @lang('hrm::cadre_officer_info.next_step')
                                </button>--}}
