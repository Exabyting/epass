        ...
        <div class="row">
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                ...
                                {{--                                    <a href="{{ route('appraisal-request.first-evaluation-edit', $ngAppraisalRequest->id) }}" class="btn btn-primary btn-lg">--}}
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['ng-appraisal-request.second-evaluation-update', $ngAppraisalRequest->id],'class' => 'form appraisal-evaluation-form']) !!}
                            <div class="form-body">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    @foreach(trans('hrm::appraisal.ng-rating-options') as $key => $value)
                                                        <input type="radio" name="summarized_rating"
                                                               {{ $ngAppraisalRequest->summarizedEvaluation->summarized_rating == $key ? "checked" : "" }}
                                                    ...
                                                    @foreach(trans('hrm::appraisal.ng-final_decision') as $value => $decision)
                                                        <fieldset>
                                                            <input type="radio" name="final_decision"
                                                                   {{ $ngAppraisalRequest->summarizedEvaluation->final_decision == $value ? "checked" : "" }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ $errors->has('name') ? ' error' : '' }}">
                                            ...
                                            {!! Form::select('receiver_id',
                                                $reportingOfficers, $ngAppraisalRequest->summarizedEvaluation->receiver_id,
                                                [
                                                    'style'=> 'max-width: 100%',
                            ...
                            <div class="form-actions text-center">
                                @if($ngAppraisalRequest->receiver->user->id === auth()->user()->id && $ngAppraisalRequest->is_evaluated)
                                    <a href="{{ route('appraisal-request.first-evaluation-edit', $ngAppraisalRequest->id) }}"
                                ...
                                <a class="btn btn-warning mr-1" role="button"
                                   href="{{ route('appraisal-request.second-evaluation-show', $ngAppraisalRequest->id) }}">
