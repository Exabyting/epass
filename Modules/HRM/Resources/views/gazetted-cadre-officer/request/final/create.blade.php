...
@section('title', 'Appraisal Request Approval')

@section('content')
    @include('hrm::gazetted-cadre-officer.request.final.partials.evaluation_completed')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"
                            id="striped-row-layout-basic">@lang('hrm::appraisal.title') @lang('labels.form')</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['gco-appraisal-request-approval.store', 'gcoAppraisalRequest' => $gcoAppraisalRequest->id ],'class' => 'form appraisal-request-form']) !!}
                            @include('hrm::gazetted-cadre-officer.request.final.partials.form')
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
