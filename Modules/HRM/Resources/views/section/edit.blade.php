...
@section('title', trans('hrm::department.section_title'))
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="repeat-form">@lang('hrm::department.section_edit')</h4>
...
{{--                    </ul>--}}
            ...
            <div class="card-content collapse show" style="">
                <div class="card-body">
                    {!! Form::model($section, ['route' =>  ['sections.update', $section->id], 'method' => 'PUT', 'class' => 'form',' novalidate']) !!}
                    @include('hrm::section.form')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
