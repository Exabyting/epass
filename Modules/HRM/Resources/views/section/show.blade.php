            ...
            <div class="card-body">
                ...
                <div class="tab-content ">
                    <div class="tab-pane active show" role="tabpanel" id="general" aria-labelledby="general-tab"
                        ...
                        <a class="btn btn-small btn-info" href="{{ route('sections.edit', ['id' => $section->id] ) }}">@lang('labels.edit')</a>
                        <a class="btn btn-small btn-danger" href="{{route('sections.index')}}">@lang('labels.back_page')</a>
