            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if ($errors->has('rating')) <h6 class="text-danger"> * চিহ্নিত অপশন গুলো বাছাই করুন </h6> @endif
                        <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['appraisal-request.first-evaluation-store', $appraisalRequest->id],'class' => 'form appraisal-evaluation-form']) !!}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    @foreach($evaluationQuestions as $evaluationQuestion)
                                        @if($evaluationQuestion->type == config('constants.question_type.primary'))
                                            <div class="col-md-6 ">
                                                <div class="form-group {{ $errors->has('rating['. $evaluationQuestion->id .']') ? ' error' : '' }}">
                                                    <label
                                                        for="rating[{{$evaluationQuestion->id}}]" class="form-label required">{{ $evaluationQuestion->position }}
                                                    ...
                                                    <div class="row skin skin-square radio ">
                                                        <div class="col-md-12 col-sm-12">
                                                            ...
                                                            <input type="text" name="comment[{{$evaluationQuestion->id}}]">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row skin skin-square">
                                                        <div class="col-md-12 col-sm-12">
                                                            <fieldset>
                                                                <input type="radio"
                                                                       name="applicable_rating[{{$evaluationQuestion->id}}]"
                                                                       value="1">
