        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['appraisal-request.action-store', $appraisalRequest->id],'class' => 'form appraisal-evaluation-form']) !!}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="row skin skin-square">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="form-label required"> আমি মনে করি যে, রিপোর্ট
                                                        প্রদানকারী অফিসারের মূল্যায়নঃ </label>
                                                    ...
                                                    @foreach(trans('hrm::appraisal.action-rating-options') as $key => $value)
                                                        @if($appraisalRequest->action->rating == $key)
                                                            <input readonly class="form-control radio required"
                                                                   checked
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <textarea readonly name="comment" class="form-control required" rows="5"
                                                      data-msg-required="{{ trans('labels.This field is required')}}">{{$appraisalRequest->action->comment}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{--                                </a>--}}
                                <a class="btn btn-info mr-1" role="button"
                                   href="{{ route('appraisal-request.action', [$appraisalRequest->id]) }}">
...
{{--                                    <i class="la la-close"></i> @lang('labels.reject')--}}
{{--                                </button>--}}

                                <a class="btn btn-warning mr-1" role="button"
                                   href="{{ route('appraisal-request.index') }}">
