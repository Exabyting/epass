                                            ...
                                            <div class="row skin skin-square">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    @foreach(trans('hrm::appraisal.action-rating-options') as $key => $value)
                                                        @if(optional($appraisalRequest->action)->rating == $key)
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="comment" class="form-control required" rows="5"
                                                      data-msg-required="{{ trans('labels.This field is required')}}">{{optional($appraisalRequest->action)->comment}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{--                                </a>--}}
                                ...
                                {{--                                    <i class="la la-check-square-o"></i> Reject--}}
                                {{--                                </button>--}}
