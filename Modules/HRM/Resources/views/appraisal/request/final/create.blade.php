...
@section('content')
    @include('hrm::appraisal.request.final.partials.evaluation_completed')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open(['route' =>  ['appraisal-request-approval.store', 'appraisalRequest' => $appraisalRequest->id ],'class' => 'form appraisal-request-form']) !!}
                            @include('hrm::appraisal.request.final.partials.form')
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
