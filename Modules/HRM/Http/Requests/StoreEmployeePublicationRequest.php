...
class StoreEmployeePublicationRequest extends FormRequest
{
    ...
    public function rules(Request $request)
    {
	    ...
	    return [
		    'publication.*.type_of_publication'       => 'required',
		    'publication.*.author_name'       => 'required',
		    'publication.*.publication_title'       => 'required',
		    'publication.*.publication_company'       => 'required',
