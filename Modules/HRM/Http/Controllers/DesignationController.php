...
class DesignationController extends Controller
{
    ...
    {
        $response = $this->designationService->updateDesignation($request->all(), $id);
        Session::flash('message', $response->getContent());
    ...
    {
//        $response = $this->designationService->delete($id);
//        Session::flash('message', trans('labels.delete_success', ['date' => date('d M Y, h:i A',time())]));
